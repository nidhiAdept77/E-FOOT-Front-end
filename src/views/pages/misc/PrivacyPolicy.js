...
export default function PrivacyPolicy() {
    return (
        <>
            <Breadcrumbs breadCrumbTitle={<FormattedMessage id="Privacy Policy" />} breadCrumbActive={<FormattedMessage id="Privacy Policy" />} />
            <Card>
                <CardBody>
                    <Row>
                        <Col md="12">
                        ...
                        <Col className="mt-2 mb-2 decimal-order-list" md="12">
                            ...
                            <ol>
                                    ...
                                    <ol>
                                        <li>
                                            ...
                                            <ol>
                                                ...
                                                <li>
                                                     shall use contractual or other measures to require third parties that process information or provide services on Our behalf to maintain a level of privacy protection comparable to Our own practices.
                                                </li>
                                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            ...
                                            <ol>
                                                ...
                                                <li>
                                                    Through the withdrawal of funds from Your bank account, where we need Your Personal Information, such as Your contact details, credit card details and billing addresses to verify You and Your identity;
                                                </li>
                                                <li>
                                                    When You Edit your User Account where we require the Personal Information for the purpose of updating Your contact information, Your Site information credentials, Your password, and Your communication preferences. In such instances, we shall collect Personal Information including but not limited to Your first name, last name, street address, city, postal or zip code, province or state, country and phone number; your avatar and any other Personal Information which We may require to update, such as information related with the “About You” query where we shall collect Your Personal Information contained in that description;
                                                </li>
                                                <li>
                                                    When You Play on Our Site, we collect Personal Information about Your game challenges, game preferences, User Profile information and any other of Your platform names for platforms supported on the Site for us to track your game results; and
                                                </li>
                                                <li>
                                                    The Site also provides you with certain ways to voluntarily give us your Personal Information including the following instances:
                                                        <ul>
                                                            <li>
                                                ...
                                                <li>
                                                    In addition to collecting Personal Information directly from visitors to the Site, we may also collect Personal Information from third parties such as marketing partners to which permission has been granted to share that information with us. 
                                                </li>

                                                <li>
                                                    Our Site is intended for a general audience and We do not knowingly:
                                                </li>
                                                ...
                                                <li>
                                                    In addition, in the event that a visitor to our Site identifies himself or herself as a person under the age of eighteen (18), We will not collect, store or use any Personal Information of such individual.
                                                </li>

                                                <li>
                                                    In the event that We receive Personal Information that we discover was provided by a person under the age of eighteen (18), We will promptly delete all such Personal Information not required for purpose of continuing to block such person's use of the Site, and will comply with applicable laws.
                                                </li>
                                            </ol>
                                        </li>
                                        <li>
                                            We collect different types of Non-Personal Information about You through Your use of Our Services. This information is collected through various media, including but not limited to through Our webservers, automatic recordings of certain technical information related to your visit to the Site and others. This information is anonymous and does not identify you personally. We collect the following Non-Personal Information:
                                            <ol>
                                                <li>
                                                ...
                                                <li>
                                                    The Internet Protocol address of the computer accessing the Site;
                                                </li>

                                                <li>
                                                    The address of the last webpage that You visited prior to clicking through to the Site;
                                                </li>

                                                <li>
                                                    The browser used and the type of computer operating system that Your computer is using;
                                                </li>
                                ...
                                <li className="mt-1 mb-1">
                                    ...
                                    <ol>
                                        <li>
                                            Cookies are small text files, they cannot run on your computer, search your computer for other information, or transmit any information to anyone. A cookie containing a unique identification number that is transferred (through your browser) from a website to the hard drive of your computer. The cookie identifies your browser but will not let a website know any Personal Information about you, such as your name or address. These files are then used by such Sites as a kind of electronic identification tag when users revisit that Site. As with many major websites, Our Site use cookies. Cookies are used by the Site so that we can recognize you when you return to the Site and personalize your settings and preferences. Most browsers are initially set up to accept cookies.
                                        </li>
                                        <li>
                                            If You wish, You can change Your browser settings either to notify You when You have received a cookie, or to refuse to accept cookies.
                                        </li>
                                    </ol>
                                </li>
                                <li className="mt-1 mb-1">
                                    Limits to Collecting Personal Information
                                    <ol>
                                        <li>
                                            We collect only the Personal Information that is required for the purposes described in this Section, hereinafter referred to as the “Purposes”.
                                        </li>

                                        <li>
                                            We collect, use and disclose your Personal Information for such internal purposes to which You consent at the time of collection or in any case prior to such use, and as otherwise permitted or required by applicable law, including the following cases:
                                            <ul>
                                                <li>
                                ...
                                <li className="mt-1 mb-1">
                                    ...
                                    <ol>
                                        <li>
                                            There may be instances when We may disclose Personal Information without providing notice or choice, as required or permitted by applicable laws, which may include:
                                            <ol>
                                                <li>
                                                    To Our advisers, including but not limited to Our legal advisers and other concerned employees, technical experts and/or other technical individuals appointed by Us in defending claims lodged against Us;
                                                </li>
                                                <li>
                                                    Where required pursuant to a subpoena, other form of legal process such as investigations and/or requests made by any local, provincial, state, or federal governmental department or agency;
                                                </li>
                                                <li>
                                                    In an emergency, to protect the safety and physical security of Users of the Services or members of the public; or
                                                </li>
                                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            ...
                                            <ol>
                                                ...
                                                <li>
                                                    Technology safeguards, including the operation of security software and firewalls, in order to prevent hacking or other unauthorized computer access; and 
                                                </li>
                                                <li>
                                        ...
                                        <li>
                                            Notwithstanding our commitment and employment of controls, no data transmission or storage can be guaranteed to be 100% secure. You agree to take reasonable steps to guard against identity theft, including 'phishing' attacks. You are responsible for maintaining the confidentiality of your password and account, and You are fully responsible for all activities that occur under Your password or account. In the event of unauthorized use of Your password or account or any other breach of security, You must notify us immediately and promptly change Your password.
                                        </li>
                                    </ol>
                                </li>
                                <li className="mt-1 mb-1">
                                    Governing Law, Jurisdiction and Change of The Data Privay Policy
                                    <ol>
                                        
                                        <li>
                                            The Site is governed by and operated in accordance with the laws of the Republic of Malta, including but not limited to the Data Protection Act (Cap.586 of the laws of Malta), and any national and European Union legislative developments that shall be applicable from time to time. Any disputes shall be resolved in the Courts of the Republic of Malta as stipulated under Section 27 of the Terms.
                                        </li>
                                        ...
                                        <li>
                                            All of Our policies and procedures are reviewed and updated periodically to reflect changes in our practices and Services, including this Privacy Policy. If We modify this Privacy Policy, We will update the "Effective Date" and such changes will be effective upon posting to the Site. We shall however inform You with the changes carried out to the Privacy Policy, by virtue of a notice uploaded on our website to this effect.
                                        </li>
                                    </ol>
                                </li>
                            </ol>
